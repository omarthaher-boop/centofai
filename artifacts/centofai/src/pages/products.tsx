...
const PRODUCTS = [
  ...
  },
  {
    ...
    icon: Brain,
    color: "#22D3EE",
    href: "mailto:info@centof.ai?subject=KI%20Consulting",
  ...
  },
  {
    ...
    icon: Code,
    color: "#10A37F",
    href: "mailto:info@centof.ai?subject=API%20Integration",
  ...
  },
  {
    ...
    icon: Wrench,
    color: "#8B5CF6",
    href: "mailto:info@centof.ai?subject=Custom%20KI%20Lösung",
